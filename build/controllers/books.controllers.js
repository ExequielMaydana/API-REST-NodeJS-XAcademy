...
var createBooks = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, isbn, title, author, year, libraryId, newBook;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, isbn = _req$body.isbn, title = _req$body.title, author = _req$body.author, year = _req$body.year, libraryId = _req$body.libraryId;
          _context.prev = 1;
          _context.next = 4;
          return books.create({
            id: uuid.v4(),
  ...
  return function createBooks(_x, _x2, _x3) {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          todoBooks = _context2.sent;
          res.status(200).json({
            items: todoBooks.length,
            books: todoBooks
          });
          _context2.next = 11;
          break;
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          bookFound = _context3.sent;
          if (!bookFound) {
            res.status(404).json({
              message: "The book with the ".concat(req.params.id, " does not exist")
            });
          } else {
            res.status(200).json({
              bookFound: bookFound
...
var editBook = /*#__PURE__*/function () {
  ...
  return function editBook(_x10, _x11, _x12) {
...
var deleteBook = /*#__PURE__*/function () {
  ...
  return function deleteBook(_x13, _x14, _x15) {
